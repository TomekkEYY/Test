...
public class SolomonIslandBlueQuestActivity extends Activity {
	...
	protected void onStart() {
		...
		// linearLayoutFarmingLocations = (ViewGroup)
		// findViewById(R.id.ll_solomon_blue_quest_locations);

		// Blue Mountain Views
		// blueFarmingLocationsBlank =
		// findViewById(R.id.blue_quest_locations_blank);
		...
		// blueFarmingLocations = (Button)
		// findViewById(R.id.blue_quest_locations);
		// blueFarmingLocationsClose = (Button)
		// findViewById(R.id.blue_quest_locations_close);
		//
	...
	// OnClickListener kingsmouthFarmingLocationsListener = new
	// OnClickListener() {
	// public void onClick(View v) {
	// if (linearLayoutFarmingLocations.getChildAt(4).getVisibility() ==
	// View.VISIBLE) {
	// for (int i = 4; i <= 5; i++) {
	...
	// OnClickListener kingsmouthFarmingLocationsCloseListener = new
	// OnClickListener() {
	// public void onClick(View v) {
	//
	// for (int i = 4; i <= 5; i++) {
	...
	// public void onClick(View v) {
	// if (linearLayoutFarmingLocations.getChildAt(10).getVisibility() ==
	// View.VISIBLE) {
	// for (int i = 10; i <= 11; i++) {
	// viewHolder = linearLayoutFarmingLocations.getChildAt(i);
	// viewHolder.setVisibility(View.GONE);
	...
	// OnClickListener savageFarmingLocationsCloseListener = new
	// OnClickListener() {
	// public void onClick(View v) {
	//
	// for (int i = 10; i <= 11; i++) {
	...
	// public void onClick(View v) {
	// if (linearLayoutFarmingLocations.getChildAt(16).getVisibility() ==
	// View.VISIBLE) {
	// for (int i = 16; i <= 29; i++) {
	// viewHolder = linearLayoutFarmingLocations.getChildAt(i);
	// viewHolder.setVisibility(View.GONE);
